...
internal class Int32DirectTag : ContinuousBytesBasedDirectTag<Int32>
{
    public Int32DirectTag(TagDescriptor descriptor, S7TagChannel? thisChannel, TagContainer parent)
