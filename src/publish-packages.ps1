...
$projects = @("Itminus.Tags", "Itminus.Tags.BlazorLib", "Itminus.Tags.RxExtensions", "Itminus.Tags.ModbusTcp", "Itminus.Tags.S7", "Itminus.Tags.ZLan","Itminus.Tags.OpcUaClient")
