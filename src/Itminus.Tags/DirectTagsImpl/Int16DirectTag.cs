...
internal class Int16DirectTag : ContinousBytesBasedDirectTag<Int16>
{
    public Int16DirectTag(TagDescriptor descriptor, ITagChannel? thisChannel, IContinousBytesBasedTagChannel channel)
