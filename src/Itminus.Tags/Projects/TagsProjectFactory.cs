...
{
    private readonly ITagChannelsLoader channelsLoader;
    ...
    public TagsProjectFactory(ITagChannelsLoader channelsLoader, ITagsLoader tagsLoader, ILogicetLoader logicetLoader, ILogicetMaker logicetMaker,IServiceProvider sp)
    {
